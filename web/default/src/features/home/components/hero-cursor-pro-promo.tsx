...
interface HeroCursorProPromoProps {
  className?: string
  animationDelay?: string
}

export function HeroCursorProPromo(props: HeroCursorProPromoProps) {
  ...
  return (
    <Link
      to='/shop/cursor'
      className={cn(
        'group landing-animate-fade-up relative block w-full max-w-xl opacity-0 lg:max-w-none',
        props.className
      )}
      style={{ animationDelay: props.animationDelay ?? '120ms' }}
    >
      <div
        aria-hidden
      ...
      <div className='relative overflow-hidden rounded-2xl border border-cyan-400/25 bg-gradient-to-br from-cyan-500/10 via-violet-500/5 to-transparent p-px shadow-[0_0_0_1px_oklch(1_0_0/0.06),0_24px_60px_-28px_oklch(0.65_0.16_200/0.65)] transition-[transform,box-shadow] duration-300 group-hover:scale-[1.015] group-hover:shadow-[0_0_0_1px_oklch(1_0_0/0.08),0_28px_70px_-26px_oklch(0.65_0.16_200/0.75)] group-active:scale-[0.995]'>
        ...
        />
        <div className='relative flex flex-col gap-4 rounded-[calc(1rem-1px)] bg-zinc-950/85 p-4 backdrop-blur-md sm:flex-row sm:items-center sm:justify-between sm:p-5'>
